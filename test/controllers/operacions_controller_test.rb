...
class OperacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operacion" do
    assert_difference('Operacion.count') do
      post operacions_url, params: { operacion: { descripcion: @operacion.descripcion, nombre: @operacion.nombre } }
    end
  ...
  test "should update operacion" do
    patch operacion_url(@operacion), params: { operacion: { descripcion: @operacion.descripcion, nombre: @operacion.nombre } }
