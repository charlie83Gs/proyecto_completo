...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { descripcion: @empleado.descripcion, nombre: @empleado.nombre, tipo: @empleado.tipo } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { descripcion: @empleado.descripcion, nombre: @empleado.nombre, tipo: @empleado.tipo } }
